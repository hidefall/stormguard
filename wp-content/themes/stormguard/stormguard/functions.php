...
if ( ! function_exists( 'stormguard_setup' ) ) :
	...
	function stormguard_setup() {
		...
		register_nav_menus( array(
			'primary' => esc_html__( 'Primary', 'stormguard' ),
			'top_bar' => esc_html__( 'Topbar', 'stormguard' )
		) );
		...
		add_theme_support( 'custom-background', apply_filters( 'stormguard_custom_background_args', array(
 ...
 */
function stormguard_widgets_init() {
	register_sidebar( array(
		'name'          => esc_html__( 'Sidebar', 'stormguard' ),
		'id'            => 'sidebar-1',
		'description'   => esc_html__( 'Add widgets here.', 'stormguard' ),
...
add_action( 'widgets_init', 'stormguard_widgets_init' );
...
add_image_size('header_general_bg_image', 2000, 300, true);
/**
 * Enqueue scripts and styles.
 */
function stormguard_scripts() {
	// wp_enqueue_style( 'stormguard-style', get_stylesheet_uri() );

	wp_enqueue_style( 'stormguard-custom-style', get_template_directory_uri() . '/css/style.css', '20151215',  true );
	...
	wp_enqueue_script( 'stormguard-navigation', get_template_directory_uri() . '/js/navigation.js', array(), '20151215', true );

	wp_enqueue_script( 'custom-js', get_template_directory_uri() . '/js/dist/app.js', array(), '20151215', true );

	wp_enqueue_script( 'stormguard-skip-link-focus-fix', get_template_directory_uri() . '/js/skip-link-focus-fix.js', array(), '20151215', true );
